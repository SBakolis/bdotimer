...
public long countdown,day;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView text1=(TextView) findViewById(R.id.BossName);
         ...
         ArrayList<Boss> MondayList = new ArrayList<>();
         ArrayList<Boss> TuesdayList = new ArrayList<>();
         ArrayList<Boss> WednesdayList = new ArrayList<>();
         ArrayList<Boss> ThursdayList = new ArrayList<>();
         ArrayList<Boss> FridayList = new ArrayList<>();
         ArrayList<Boss> SaturdayList = new ArrayList<>();
